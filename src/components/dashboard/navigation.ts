import { CalendarDays, CircleDollarSign, ClipboardList, ClipboardPlus, FileHeart, LayoutDashboard, Settings, ShieldCheck, UsersRound } from "lucide-react";
export const dashboardNavigation = [
  ...
  { title: "Cadastros", href: "/dashboard/cadastros", icon: ClipboardList },
